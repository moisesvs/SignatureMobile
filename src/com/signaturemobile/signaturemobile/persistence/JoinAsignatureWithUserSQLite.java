...
public class JoinAsignatureWithUserSQLite extends SQLiteBaseData {

	/**
	 * Sql statement create table
	 */
	protected static String sqlCreateTable = "CREATE TABLE JoinAsignatureWithUserSQLite (code INTEGER, nameAsignature TEXT, username TEXT)";

	/**
	 * Sql statement delete table
	 */
	protected static String sqlDeleteTable = "DROP TABLE IF EXISTS JoinAsignatureWithUserSQLite";
     ...
     */
    public JoinAsignatureWithUserSQLite(Context context, String name,
