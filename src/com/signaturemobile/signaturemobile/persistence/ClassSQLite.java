...
public class ClassSQLite extends SQLiteBaseData {

	/**
	 * Sql statement create table
	 */
	protected static String sqlCreateTable = "CREATE TABLE Class (code INTEGER, nameClass TEXT, numberStudents TEXT)";

	/**
	 * Sql statement delete table
	 */
	protected static String sqlDeleteTable = "DROP TABLE IF EXISTS Class";
     ...
     */
    public ClassSQLite(Context context, String name,
